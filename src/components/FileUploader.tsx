import { FileUpload, FileUploadHandlerEvent, FileUploadRemoveEvent } from "primereact/fileupload";
...
const FileUploader: FC<FileUploaderProps> = ({path = '/photo', maxSize = 100000, setFilesLinks}) => {
    ...
    const cancelOptions = { disabled: isDisabled,icon: 'pi pi-fw pi-times', iconOnly: true, className: 'custom-cancel-btn p-button-danger p-button-rounded p-button-outlined' };
    ...
    return (
        <>
            ...
            <FileUpload 
                ...
                accept="image/*" 
                maxFileSize={maxSize} 
                emptyTemplate={<p style={{fontWeight: '500'}} className="m-0">Drag and drop Photos to here to upload.</p>} 
            />
        </>
    );
}
